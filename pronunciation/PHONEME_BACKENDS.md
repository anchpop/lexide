...
stratum (including both TTS backends), plus synthetic edge cases. **Korean's
verification is still text fixtures and synthetic adapter cases only** — that
was a necessity before 2026-09-11 and is now a known gap, since Korean audio
exists and the fixtures have not been extended to sample its strata.

...
This will:
1. Download the base Gemma 4 E2B model
2. Download your LoRA adapter from HuggingFace
3. Merge them together
4. Upload the merged model to `anchpop/lexide-gemma-4-E2B-it-merged`
...
python merge_lora.py --base-model google/gemma-4-E2B-it
```
...
let config = LexideConfig {
    model_repo: "anchpop/lexide-gemma-4-E2B-it-merged".to_string(),
    ..Default::default()
};
```
...
1. Load config from base model (`google/gemma-4-E2B-it`)
